...
class QwenImageEditPlusPipeline(DiffusionPipeline, QwenImageLoraLoaderMixin):
    ...
    def _get_qwen_prompt_embeds_negative(
        self,
        prompt: Union[str, List[str]] = None,
        image: Optional[torch.Tensor] = None,
        device: Optional[torch.device] = None,
    ...
    def encode_prompt_negative(
        ...
        if prompt_embeds is None:
            prompt_embeds, prompt_embeds_mask = self._get_qwen_prompt_embeds_negative(prompt, image, device)
