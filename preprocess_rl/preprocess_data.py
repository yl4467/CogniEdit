...
import sys
import json
#from edit_train_dataset import OmniGen2TrainDataset, OmniGen2Collator
from edit_train_dataset_gpose import OmniGen2TrainDataset, OmniGen2Collator
sys.path.append('..')
...
def generate(
        ...
        '''
        if do_true_cfg:
            negative_prompt_embeds, negative_prompt_embeds_mask = self.encode_prompt_negative(
                image=condition_images,
...
def main(args: argparse.Namespace, root_dir: str) -> None:
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        input_image_path = batch['input_images_path']
        batch_instruction = batch['instruction'][0]
        output_paths = batch['output_image_path']
        #input_images = preprocess(args.input_image_path)
        print(input_images[0][0].size)
        # Generate and save image
        input_image_id = os.path.basename(input_image_path[0][0])[:-4]
        root_path = "/home/ma-user/work/yanli/test_yl/Omni_Pos_Data/input_data_rl_512"
        ...
        data = {
            ...
            "source_image": f"images/{os.path.basename(input_image_path[0][0])}", 
        ...
        with open("/home/ma-user/work/yanli/test_yl/gRefCOCO/" + f'test_512_{step//10000}.jsonl', 'a+', encoding='utf-8') as f:
