...
class OmniGen2TrainDataset_smart(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        data_files = ["/home/ma-user/work/yanli/test_yl/editworld_dataset/t2i_branch/" + file for file in os.listdir("/home/ma-user/work/yanli/test_yl/editworld_dataset/t2i_branch")]
    ...
    def process_item(self, data_item):
        ...
        input_images = [Image.open(io.BytesIO(data_item['original_image']))]
        input_image_pil =  [Image.open(io.BytesIO(data_item['original_image'])).convert("RGB")]
        output_image = Image.open(io.BytesIO(data_item['target_image']))
        ...
        '''
        output_image_path, input_image_path = None, None
